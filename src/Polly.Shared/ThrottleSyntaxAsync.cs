...
namespace Polly
{
    ...
    public partial class Policy
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static ThrottlePolicy ThrottleAsync()
        {
            return ThrottleAsync(Environment.ProcessorCount);
        }
        ...
        /// <returns></returns>
        public static ThrottlePolicy ThrottleAsync(int maxParallelization, int maxQueuedActions = int.MaxValue)
        {
            ...
            return new ThrottlePolicy((action, context, cancellationToken, continueOnCapturedContext) =>
                ThrottleEngine.ImplementationAsync(
