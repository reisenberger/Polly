...
namespace Polly
{
    public partial class Policy
    {
            ...
            Action<Context, string, Exception> onCachePutError)
        {
            ...
            return new CachePolicy<TResult>(policy => new CacheSyncImplementation<TResult>(cacheProvider, ttlStrategy, cacheKeyStrategy, onCacheGet, onCacheMiss, onCachePut, onCacheGetError, onCachePutError));
        }
    }
}
