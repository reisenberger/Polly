...
namespace Polly
{
    ...
    public static class CircuitBreakerSyntaxAsync
    {
        ...
        /// <exception cref="ArgumentNullException">onReset</exception>
        /// <exception cref="ArgumentNullException">onHalfOpen</exception>
        public static CircuitBreakerPolicy CircuitBreakerAsync(this PolicyBuilder policyBuilder, IConsecutiveCountCircuitBreakerConfiguration configuration, Action<Exception, TimeSpan, Context> onBreak, Action<Context> onReset, Action onHalfOpen)
        {
