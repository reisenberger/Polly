...
namespace Polly
{
    ...
    public static class AdvancedCircuitBreakerSyntax
    {
        ...
        /// <exception cref="ArgumentNullException">onHalfOpen</exception>
        /// <remarks>(see "Release It!" by Michael T. Nygard fi)</remarks>
        public static CircuitBreakerPolicy AdvancedCircuitBreaker(this PolicyBuilder policyBuilder, IAdvancedCircuitBreakerConfiguration configuration, Action<Exception, TimeSpan, Context> onBreak, Action<Context> onReset, Action onHalfOpen)
        {
