...
namespace Polly
{
    ...
    public class Context : ReadOnlyDictionary<string, object>
    {
        ...
        internal static readonly Context Empty = new Context(emptyDictionary);
        ...
        internal void SetPolicyContext(Policy executingPolicy)
        {
            ...
            {
                _policyWrapKey = ((PolicyWrap) executingPolicy).PolicyWrapKey;
            }
        }
        ...
        internal void SetPolicyContext<TResult>(Policy<TResult> executingPolicy)
        {
            ...
            {
                _policyWrapKey = ((PolicyWrap<TResult>)executingPolicy).PolicyWrapKey;
            }
        }
    }
}