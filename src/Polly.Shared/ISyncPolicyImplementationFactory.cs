...
{
    /// <summary>
    /// Defines a factory for providing synchronous implementations for the given non-generic policy.
    /// </summary>
    public interface ISyncPolicyImplementationFactory
    {
        /// <summary>
    ...
    /// <summary>
    /// Defines a factory for synchronous implementations of the given policy, which is generic-typed to execute delegates returning an instance of <typeparamref name="TResult"/>.
    /// </summary>
    /// <typeparam name="TResult">The type of results returned by delegates executed through the owning policy.</typeparam>
    public interface ISyncPolicyImplementationFactory<TResult>
    {
        /// <summary>
